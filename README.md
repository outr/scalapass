...
## SBT
```sbt
libraryDependencies += "com.outr" %% "scalapass" % "1.3.0"
```
...
// hashed: String = "$argon2id$v=19$m=65536,t=50,p=8$LotiI6Vy19XY0znXWk7n/w$IhEUYQdg8SDyZ58F0sMecBPTsePbuqp6Y32HtYQIaHU"
```
...
// hashedPassword: String = "$argon2id$v=19$m=65536,t=50,p=8$LotiI6Vy19XY0znXWk7n/w$IhEUYQdg8SDyZ58F0sMecBPTsePbuqp6Y32HtYQIaHU"
